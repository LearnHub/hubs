    ...
    if (this.state.isStarted) {
      return (
        <div className={styles.resultsContainer}>
          ...
          <Button preset="primary" className={styles.actionButton} onClick={this.copyTable}>{this.state.copyButtonLabel}</Button>
        </div>

      );
    } else {
      return (
        <Button preset="primary" className={styles.actionButton} onClick={this.dowloadMetadata}>Start Connection Test</Button>
      );
    }
  }
}
