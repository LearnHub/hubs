...
import { AvnDeviceInvitePopoverButton } from "./AvnDeviceInvitePopover";
import { handleExitTo2DInterstitial } from "../../utils/vr-interstitial";
import { useInviteUrl } from "./useInviteUrl";

export function AvnDeviceInvitePopoverContainer({ hub, hubChannel, scene, store, ...rest }) {
...
AvnDeviceInvitePopoverContainer.propTypes = {
